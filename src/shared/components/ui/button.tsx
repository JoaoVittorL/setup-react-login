...
const buttonVariants = cva(
  'h-8 flex gap-2 items-center justify-center whitespace-nowrap rounded-md text-sm  transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-primary-500 text-primary shadow hover:bg-green-600/80',
        ...
        off: 'border-none border-transparent bg-transparent shadow-none outline-none hover:bg-transparent hover:shadow-none focus:bg-transparent focus:shadow-none',
      },
      size: {
        default: 'px-3 py-2',
